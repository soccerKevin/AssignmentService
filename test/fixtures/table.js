...
import { fakeAddress } from './helpers.js'
...
export const data = [
  { name: 'smurf',   grade: 3, address: fakeAddress() },
  { name: 'penny',   grade: 4, address: fakeAddress() },
  { name: 'sheldon', grade: 2, address: fakeAddress() },
  { name: 'leonard', grade: 2, address: fakeAddress() },
  { name: 'raj',     grade: 4, address: fakeAddress() },
  { name: 'howard',  grade: 4, address: fakeAddress() },
]
